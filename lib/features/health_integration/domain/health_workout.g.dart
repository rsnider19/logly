...
_HealthWorkout _$HealthWorkoutFromJson(Map<String, dynamic> json) => _HealthWorkout(
...
Map<String, dynamic> _$HealthWorkoutToJson(_HealthWorkout instance) => <String, dynamic>{

...
class ActivityNotFoundException extends CatalogException {
  const ActivityNotFoundException([String? technicalDetails])
...
class CategoryNotFoundException extends CatalogException {
  const CategoryNotFoundException([String? technicalDetails])
      : super('Category not found.', technicalDetails);
}

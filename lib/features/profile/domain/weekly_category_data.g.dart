...
_WeeklyCategoryData _$WeeklyCategoryDataFromJson(Map<String, dynamic> json) => _WeeklyCategoryData(
  dayOfWeek: (json['day_of_week'] as num).toInt(),
  activityCount: (json['activity_count'] as num).toInt(),
  activityCategoryId: json['activity_category_id'] as String?,
);

Map<String, dynamic> _$WeeklyCategoryDataToJson(_WeeklyCategoryData instance) => <String, dynamic>{

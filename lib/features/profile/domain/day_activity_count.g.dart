...
_DayActivityCount _$DayActivityCountFromJson(Map<String, dynamic> json) => _DayActivityCount(
  date: DateTime.parse(json['activity_day'] as String),
  count: (json['activity_count'] as num).toInt(),
);

Map<String, dynamic> _$DayActivityCountToJson(_DayActivityCount instance) => <String, dynamic>{

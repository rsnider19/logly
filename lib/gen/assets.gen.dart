...
class $EnvGen {
  ...
  String get aEnvStaging => 'env/.env.staging';
...
class Assets {
  ...
  static const AssetGenImage launcherIcon = AssetGenImage('assets/launcher_icon.png');
  static const String logoLight = 'assets/logo-light.svg';
  static const $EnvGen env = $EnvGen();

  /// List of all assets
  static List<dynamic> get values => [launcherIcon, logoLight];
}

...
/// Chat history route - conversation history list.
@TypedGoRoute<ChatHistoryRoute>(path: '/chat/history')
class ChatHistoryRoute extends GoRouteData with $ChatHistoryRoute {
